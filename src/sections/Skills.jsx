import { SiMongodb, SiExpress, SiDjango, SiSqlite, SiPython, SiTailwindcss } from "react-icons/si";
  ...
  return (
    <section id="skills" ref={sectionRef}
      ...
      <motion.h2 className="text-4xl mt-5 sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] z-10"
        initial={{ opacity: 0, y: -30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
        My Skills
      </motion.h2>
      <motion.p className="mt-2 mb-8 text-white/90 text-base sm:text-lg z-10"
        initial={{ opacity: 0, y: -10 }} whileInView={{ opacity: 1, y: 0 }}>
        MERN Stack · Django · Systems Programming
      </motion.p>
